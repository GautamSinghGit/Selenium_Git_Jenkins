...
@CucumberOptions(
        ...
        plugin = {"pretty","timeline:./Reports/","json:JsonReport/cucumber.json","html:./Reports/cucureport.html","rerun:RerunFeatures/reruns.txt","com.aventstack.extentreports.cucumber.adapter.ExtentCucumberAdapter:"},
        publish = true
      //  tags = "@Mobiles"
)
